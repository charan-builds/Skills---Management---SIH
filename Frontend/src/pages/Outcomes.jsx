...
export default function Outcomes() {
  ...
  const handleVerifySubmit = async (e) => {
    ...
    try {
      await fetchAuth(`${API_BASE}/api/trainees/${selectedVerification.trainee_id}/followup`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          checkpoint: "Employment Verification",
          employment_status: "Employed",
          employer_or_activity: selectedVerification.employer || "Enterprise Partner",
          salary: selectedVerification.salary || "₹45,000",
          job_relevance: "High",
          verification_status: verifyStatus,
          description: verifyRemarks || "Attested by State System Administrator."
        })
      });

      await fetchAuth(`${API_BASE}/api/trainees/${selectedVerification.trainee_id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          outcome: "Employed",
